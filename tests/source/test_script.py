...
def test_parameters_description_passed(
    ...
    validate_image_metadata(
        ...
        description_long=response_fixture_typed.description.wiki.en,
        description_short=response_fixture_typed.description.stock.en,
        keywords=response_fixture_typed.keywords,
    )
